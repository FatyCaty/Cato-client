...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
    	...
    	e.setType(yusuf.cato.events.EventType.PRE);
    	Cato.onEvent(e);
    	...
    	event.setType(yusuf.cato.events.EventType.PRE);
    	Cato.onEvent(event);
        ...
        event.setType(yusuf.cato.events.EventType.POST);
    	Cato.onEvent(event);
    ...
    public void onLivingUpdate()
    {
        ...
        {
        	if(Cato.getModulesByName("NoSlow").isEnabled()) {
