...
import yusuf.cato.modules.render.Animations;
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (abstractclientplayer.getItemInUseCount() > 0)
            {
                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                        if(Cato.getModulesByName("Animations").isEnabled()) {
                        	if(((Animations) Cato.getModulesByName("Animations")).getAnimationsSetting().is("1.7")) {
                        		this.transformFirstPersonItem(-0.1f, f1);
                        	}
                        	if(((Animations) Cato.getModulesByName("Animations")).getAnimationsSetting().is("Push")) {
                        		this.transformFirstPersonItem(0f,f1 - 1.1f);
                        	}
                        	if(((Animations) Cato.getModulesByName("Animations")).getAnimationsSetting().is("Weird")) {
                        		this.transformFirstPersonItem(f, f1 - 11 *2);
                        	}
                        	if(((Animations) Cato.getModulesByName("Animations")).getAnimationsSetting().is("Down")) {
